    ...
    <section class="pxa_page_title"
        ...
        <div class="pxa_container">
            <div class="pxa_page_title_opacity">
                <h2>Our Service</h2>
                <ul>
                    <li><a href="https://preview.kamleshyadav.com/nexuscms">Home /</a></li>
    ...
    <section class="pxa_allBlog_section">
        <div class="pxa_container">
            @if (request('search_keyword'))
                <div class="bg-dark text-light p-4 my-4 rounded" style="display:block">
                    <h4 class="text-center">Your Search Result is : {{ $serviceList->count() }}</h4>
                </div>
                {{-- @elseif(request('search_keyword') == null)
                <div class="bg-dark text-light p-4 my-4 rounded" style="display:none">
                    <h4 class="text-center">Your Search Result is : -  : {{ $serviceList->count() }}</h4>
                </div> --}}
            @elseif ($serviceList->count() == 0)
                <div class="bg-dark text-light p-4 my-4 rounded">
                    <h4 class="text-center">Sorry! This Category No Data Found </h4>
                </div>
            @endif
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    ...
                    @if (request()->routeIs('website.blog'))
                        @include('website.components.blog-sidebar')
                    @elseif(request()->routeIs('website.service'))
                ...
                <div class="mb-2 bg-dark text-light   p-4  rounded">
                                   <span> Total Service : {{ $serviceList->count() }}</span>
                                </div>
                                @else
                                no data
                                @endif --}}
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-4">
                                    ...
                                    <div class="pxa_allBlog_girdItem">
                                        <a href="{{ route('website.service.details', $item->slug) }}">
                                            <img class="pxa_img_radius" @if($item->image) src="{{ asset($item->image) }}" @else src="{{ asset('uploads/no-image.png') }}" @endif alt="{{ $item->slug }}"
                                            ...
                                            <div class="pxa_allBlog_content">
                                                ...
                                                <div class=" py-2">
                                                    ...
                                                    <span class=" ml-3"> Category : {{ $item->category->name }}</span>
                                                </div>
                                                <h4>{{ $item->title }}</h4>
