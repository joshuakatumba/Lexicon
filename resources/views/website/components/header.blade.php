...
<html lang="en">
   ...
   <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
       <title>@yield('title', 'LEXICON - Build Your Website With Dynamic Modules')</title>
      ...
      <meta property="og:title" content="LEXICON - Build Your Website With Dynamic Modules" />
      <meta property="og:description"
         content="Empower your online presence with dynamic modules and an intuitive page builder. Unleash creativity to design your unique website effortlessly. Start now!" />
      <meta property="og:url" content="https://preview.kamleshyadav.com/nexuscms" />
      <meta property="og:image"
         content="{{ asset('frontend') }}/public/storage/site_images/grMN6fzmbN0caP1iP7qvXloCxSZXtIUPBWEDDQbp.jpg" />
      <!-- favicon -->
      <link href="{{ asset('uploads/website/lexicon-favicon.svg') }}" rel="icon" type="image/svg+xml">
      <link href="{{ asset('uploads/website/lexicon-favicon.svg') }}" rel="apple-touch-icon">
      <!-- stylesheet -->
      <link
