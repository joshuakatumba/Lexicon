            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <form action="{{ route('language.update', $language) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                @if($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="flag">Choose new file</label>
                                            </div>
                                            <small class="form-text text-muted">Upload a new flag image (PNG, JPG, JPEG, GIF)</small>
                                            @error('flag')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge badge-light">Not Default</span>
                                        @endif
                                    </td>
                                </tr>
                            </table>
