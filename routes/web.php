...
Route::group(['prefix' => 'admin'], function () {
   ...
   Route::get('/', [DashBoardController::class, 'index'])->name('admin.dashboard');
    ...
    Route::get('/language-test', function() {
        return 'Language route is working!';
    })->name('language.test');
    Route::resource('/language', LanguageController::class);
    Route::patch('/language/{language}/toggle-status', [LanguageController::class, 'toggleStatus'])->name('language.toggle-status');
    Route::patch('/language/{language}/set-default', [LanguageController::class, 'setDefault'])->name('language.set-default');
...
// Default route - redirect to frontend website
Route::get('/', function () {
